...
type AddGrandParents1FormProps = {
	parent1?: boolean;
	parent2?: boolean;
...
const AddGrandParents1Form: FC<AddGrandParents1FormProps> = ({
	parent1,
	parent2,
	detailsParent1,
	detailsParent2,
	...
	const isDisabled = !!(
		...
		(parent2 && questionnaireSettings?.step5_AddParent1GrandParents?.formVariants?.parent2?.details)
	);
	// const isDisabled = false;

	const [deceased, setDeceased] = useState<string>(
		parent1
			? questionnaireSettings?.step5_AddParent1GrandParents?.formVariants?.parent1?.deceased
			: questionnaireSettings?.step5_AddParent1GrandParents?.formVariants?.parent2?.deceased
	);
					...
					setting: {
						...
						step5_AddParent1GrandParents: {
							...
							isGrandParent1Added: parent1
								? true
								: questionnaireSettings?.step5_AddParent1GrandParents?.isGrandParent1Added,
							isGrandParent2Added: parent2
								? true
								: questionnaireSettings?.step5_AddParent1GrandParents?.isGrandParent2Added,
							formVariants: {
								parent1: {
									details: parent1
										? detailsParent1
										: questionnaireSettings?.step5_AddParent1GrandParents?.formVariants?.parent1
												?.details,
									deceased: deceased
										? deceased
										: questionnaireSettings?.step5_AddParent1GrandParents?.formVariants?.parent1
								...
								parent2: {
									details: parent2
										? detailsParent2
										: questionnaireSettings?.step5_AddParent1GrandParents?.formVariants?.parent2
												?.details,
									deceased: deceased
										? deceased
										: questionnaireSettings?.step5_AddParent1GrandParents?.formVariants?.parent2
			...
			{props => (
				<>
					<Box alignItems="center" justifyContent="center" mt={15} mb={5} width={'100%'}>
						<Box width={'90%'}>
							<Text my={1}>
								Would you like to add details about your Paternal{' '}
...
export default AddGrandParents1Form;
